                    ...
                    <div className="page">
                        ...
                        <div className="col-wrapper">
                                    ...
                                    <div className="info-wrapper">
                                        <div className="title-wrapper">
                                            ...
                                            <h1 className="title">
                                                ...
                                                {artist?.trending === true && <span className="trending-icon">Trending</span>}
                                            </h1>
                                        </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="tooltip-wrapper">
                                                ...
                                                <div className="tooltip">
                                                    <h3>Vote for subgenres</h3>
                                                    <p>
                                                        Don’t agree with the subgenres? Add the ones you think are missing or vote
                                                        for existing to get yours on top!
                                                    </p>
                                                    <div className="stats-sheet">
                                                        <div className="row">
                                                            <h5>Alternative rock</h5>
                            ...
                            <div className="col stats">
                                ...
                                <Graph mostPopularIn={artist?.most_popular_in} />
                            </div>
                            {/* /stats */}
                        </div>
